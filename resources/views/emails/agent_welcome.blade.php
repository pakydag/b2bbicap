...
<head>
    ...
    <title>Attivazione Account Agente B2B</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="header">
            ...
            @endif
            <p>Attivazione Account Agente</p>
        </div>
        
        <div class="content">
            <p class="greeting">Gentile <strong>{{ $agent->name }} {{ $agent->surname }}</strong>,</p>
            <p class="text-lead">
                È stato attivato il tuo account come <strong>Agente</strong> sul nostro Portale B2B.
                Di seguito trovi i tuoi dati di accesso e il riepilogo delle autorizzazioni assegnate.
            </p>

            <!-- Box Credenziali -->
            <div class="card-box" style="border-left: 4px solid #facc15;">
                <h3>🔐 Credenziali di Accesso</h3>
                <p style="margin: 4px 0; font-size: 13px;"><strong>Email (Login):</strong> {{ $agent->email }}</p>
                <p style="margin: 4px 0; font-size: 13px;"><strong>Password Temporanea:</strong> <span class="password-badge">{{ $password }}</span></p>
                <p style="margin: 10px 0 0; font-size: 11px; color: #64748b;">
                    * Ti raccomandiamo di accedere al portale e modificare la password provvisoria nella sezione profilo.
                </p>
            </div>
            ...
            <div class="card-box">
                ...
                <p style="margin: 0 0 8px; font-size: 12px; color: #64748b;">
                    Potrai consultare il catalogo e registrare ordini per i seguenti brand:
                </p>
            ...
            <div class="card-box">
                ...
                <p style="margin: 0 0 8px; font-size: 12px; color: #64748b;">
                    Sei autorizzato a gestire e caricare ordini per le seguenti anagrafiche cliente:
                </p>
